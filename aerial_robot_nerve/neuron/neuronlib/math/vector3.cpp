...
// define for int16_t
template int16_t Vector3<int16_t>::operator *(const Vector3<int16_t> &v) const;
...
// define for int32_t
template int32_t Vector3<int32_t>::operator *(const Vector3<int32_t> &v) const;
...
template Vector3<int32_t> Vector3<int32_t>::operator -(const Vector3<int32_t> &v) const;
template Vector3<int32_t> Vector3<int32_t>::operator -(void) const;
template bool Vector3<int32_t>::operator ==(const Vector3<int32_t> &v) const;
template bool Vector3<int32_t>::operator !=(const Vector3<int32_t> &v) const;
