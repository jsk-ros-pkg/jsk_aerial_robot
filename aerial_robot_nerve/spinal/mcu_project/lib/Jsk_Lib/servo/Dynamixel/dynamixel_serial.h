...
#define SET_POS_DU 10 //[msec], jinjie changed it to 10ms => 100Hz, zicen changed it to 20ms => 50Hz
#define SET_POS_OFFSET 0 // offset from SET_POS
#define GET_POS_DU 10 //[msec], jinjie changed it to 10ms => 100Hz, zicen changed it to 20ms => 50Hz
