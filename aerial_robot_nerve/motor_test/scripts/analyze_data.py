...
folder_path = '/home/jinjie/.ros/'
file_name = 'u=25.20v_motor_test_1706621604.txt'
...
axs[0, 0].grid()
axs[0, 0].text(0.95, 0.05, fit_eq_kRPM2, horizontalalignment='right', verticalalignment='bottom', transform=axs[0, 0].transAxes, fontsize=10, color='green')
...
axs[0, 1].grid()
axs[0, 1].text(0.95, 0.05, fit_eq_mz_fz, horizontalalignment='right', verticalalignment='bottom', transform=axs[0, 1].transAxes, fontsize=10, color='green')
...
axs[1, 0].grid()
axs[1, 0].text(0.95, 0.05, fit_eq_currency_fz, horizontalalignment='right', verticalalignment='bottom', transform=axs[1, 0].transAxes, fontsize=10, color='green')

# Plot 4: fz vs PWM_ratio
axs[1, 1].scatter(PWM_ratio, fz, color='blue', alpha=0.5, label='Data points')
axs[1, 1].plot(np.sort(PWM_ratio), np.polyval(coeffs_PWM_ratio_fz, np.sort(PWM_ratio)), color='red', label='Fitted polynomial')
axs[1, 1].set_title('fz vs PWM_Ratio_%')
axs[1, 1].set_xlabel('PWM_Ratio_%')
axs[1, 1].set_ylabel('fz (N)')
axs[1, 1].grid()
axs[1, 1].text(0.95, 0.05, fit_eq_PWM_ratio_fz, horizontalalignment='right', verticalalignment='bottom', transform=axs[1, 1].transAxes, fontsize=10, color='green')
