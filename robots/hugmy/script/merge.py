...
def callback(rects,classes):
    ...
    if "human" in classes.label_names:
...
Rect_sub = message_filters.Subscriber('/edgetpu_human_pose_estimator/output/rects', RectArray)
Class_sub = message_filters.Subscriber('/edgetpu_human_pose_estimator/output/class', ClassificationResult)
