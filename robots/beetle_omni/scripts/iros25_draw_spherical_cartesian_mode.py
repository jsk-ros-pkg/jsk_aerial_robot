...
def main(file_path, plot_type):
    ...
    if plot_type == 1:
        ...
        x = np.array(
            data_xyz_ref_aligned["/hand/mocap/pose/pose/position/x"]
            - data_xyz_arm_aligned["/arm/mocap/pose/pose/position/x"]
        )
        y = np.array(
            data_xyz_ref_aligned["/hand/mocap/pose/pose/position/y"]
            - data_xyz_arm_aligned["/arm/mocap/pose/pose/position/y"]
        )
