...
def main(file_path_1, file_path_2):
    ...
    data_euler_ref_1["roll"], data_euler_ref_1["pitch"], data_euler_ref_1["yaw"] = quat2euler(
        data_qwxyz_ref_1["/beetle1/set_ref_traj/x/data[6]"],
        data_qwxyz_ref_1["/beetle1/set_ref_traj/x/data[7]"],
        data_qwxyz_ref_1["/beetle1/set_ref_traj/x/data[8]"],
        data_qwxyz_ref_1["/beetle1/set_ref_traj/x/data[9]"],
    )
    ...
    data_euler_ref_2["roll"], data_euler_ref_2["pitch"], data_euler_ref_2["yaw"] = quat2euler(
        data_qwxyz_ref_2["/beetle1/set_ref_traj/x/data[6]"],
        data_qwxyz_ref_2["/beetle1/set_ref_traj/x/data[7]"],
        data_qwxyz_ref_2["/beetle1/set_ref_traj/x/data[8]"],
        data_qwxyz_ref_2["/beetle1/set_ref_traj/x/data[9]"],
    )
    ...
    data_euler_1["roll"], data_euler_1["pitch"], data_euler_1["yaw"] = quat2euler(
        data_qwxyz_1["/beetle1/uav/cog/odom/pose/pose/orientation/w"],
        data_qwxyz_1["/beetle1/uav/cog/odom/pose/pose/orientation/x"],
        data_qwxyz_1["/beetle1/uav/cog/odom/pose/pose/orientation/y"],
        data_qwxyz_1["/beetle1/uav/cog/odom/pose/pose/orientation/z"],
    )
    ...
    data_euler_2["roll"], data_euler_2["pitch"], data_euler_2["yaw"] = quat2euler(
        data_qwxyz_2["/beetle1/uav/cog/odom/pose/pose/orientation/w"],
        data_qwxyz_2["/beetle1/uav/cog/odom/pose/pose/orientation/x"],
        data_qwxyz_2["/beetle1/uav/cog/odom/pose/pose/orientation/y"],
        data_qwxyz_2["/beetle1/uav/cog/odom/pose/pose/orientation/z"],
    )
