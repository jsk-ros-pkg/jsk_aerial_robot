...
class FeasibleControlConvexPlot():
    def __init__(self, name="feasible_control_convex_plot"):
        ...
        rospy.Subscriber("feasible_control_convex_info", FeasibleControlConvexInfo, self.cb)
    ...
    def cb(self, msg):
        ...
        ax = a3.Axes3D(plt.figure("feasible_control_force_convex"))
        ...
        ax = a3.Axes3D(plt.figure("feasible_control_torque_convex"))
