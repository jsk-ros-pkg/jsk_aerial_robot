...
BeetleOmniNavigator::BeetleOmniNavigator():
                                   ...
                                   boost::shared_ptr<aerial_robot_estimation::StateEstimator> estimator)
{
  ...
  for(int i = 0; i < max_modules_num; i++){
    ...
    assembly_flag_subs_.insert(make_pair(module_name, nh_.subscribe( module_name + string("/assembly_flag"), 1, &BeetleOmniNavigator::assemblyFlagCallback, this)));
  }

}

void BeetleOmniNavigator::joyStickControl(const sensor_msgs::JoyConstPtr & joy_msg)
{
...
void BeetleOmniNavigator::naviCallback(const aerial_robot_msgs::FlightNavConstPtr & msg)
...
void BeetleOmniNavigator::assemblyFlagCallback(const diagnostic_msgs::KeyValue & msg)
{
...
void BeetleOmniNavigator::rotateContactPointFrame()
{
...
void BeetleOmniNavigator::convertTargetPosFromCoG2CoM()
{
...
void BeetleOmniNavigator::rosParamInit()
{
