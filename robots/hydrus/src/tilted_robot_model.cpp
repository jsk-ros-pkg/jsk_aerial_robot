...
HydrusTiltedRobotModel::HydrusTiltedRobotModel(bool init_with_rosparam, bool verbose, double epsilon, double control_margin_thre, double wrench_mat_det_thre):
  HydrusRobotModel(init_with_rosparam, verbose, epsilon, 4, control_margin_thre, wrench_mat_det_thre)
{
}
