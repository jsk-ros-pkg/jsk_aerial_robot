...
class ObstacleWorld:
    def __init__(self):
        ...
        # self.spawnWall("right_wall", 0.5, np.array([40,wall_y_position,2]) + np.array([shift_x,shift_y,0]) , 80, 0.01, 4)
        # self.spawnWall("left_wall", 0.5, np.array([40,-wall_y_position,2]) + np.array([shift_x,shift_y,0]), 80, 0.01, 4)
