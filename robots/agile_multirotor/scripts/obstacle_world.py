...
class ObstacleWorld:
    def __init__(self):
        ...
        self.spawnWall("desk", 0.5, np.array([1.0,0.0,0.50]) + np.array([shift_x,shift_y,0]), 0.6, 0.6, 1.0)
        self.spawnWall("polls", 0.5, np.array([1.0,-0.8,0.50]) + np.array([shift_x,shift_y,0]), 0.6, 1.0, 1.0)
