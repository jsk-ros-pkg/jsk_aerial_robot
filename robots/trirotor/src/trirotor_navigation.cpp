...
#include <trirotor/trirotor_navigation.h>

using namespace aerial_robot_model;
using namespace aerial_robot_navigation;

TrirotorNavigator::TrirotorNavigator():
  BaseNavigator(),
...
void TrirotorNavigator::initialize(ros::NodeHandle nh, ros::NodeHandle nhp,
                                   ...
                                   boost::shared_ptr<aerial_robot_estimation::StateEstimator> estimator)
{
  ...
  final_target_baselink_rot_sub_ = nh_.subscribe("final_target_baselink_rot", 1, &TrirotorNavigator::setFinalTargetBaselinkRotCallback, this);
  prev_rotation_stamp_ = ros::Time::now().toSec();

}

void TrirotorNavigator::update()
{
  BaseNavigator::update();
  baselinkRotationProcess();
}

void TrirotorNavigator::setFinalTargetBaselinkRotCallback(const spinal::DesireCoordConstPtr & msg)
{
  final_target_baselink_rot_.setValue(msg->roll, msg->pitch, msg->yaw);
}

void TrirotorNavigator::baselinkRotationProcess()
{
...
void TrirotorNavigator::rosParamInit()
{
...
PLUGINLIB_EXPORT_CLASS(aerial_robot_navigation::TrirotorNavigator, aerial_robot_navigation::BaseNavigator);
