#include <tiger/navigation/flight_navigation.h>
...
PLUGINLIB_EXPORT_CLASS(aerial_robot_navigation::Tiger::FlightNavigator, aerial_robot_navigation::BaseNavigator);
