...
void nmpc::TiltMtNominalServoNMPC::prepareNMPCRef()
{
  ...
  if (is_traj_tracking_)
  {
    ...
    {
      ROS_INFO("No traj msg for 0.5s. Trajectory tracking mode is off! Return to hovering!");
...
double nmpc::TiltMtNominalServoNMPC::getCommand(int idx_u, double T_horizon)
{
  if (T_horizon == 0)
...
std::vector<double> nmpc::TiltMtNominalServoNMPC::meas2VecX()
{
