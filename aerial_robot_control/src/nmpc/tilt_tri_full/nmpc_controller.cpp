...
void nmpc_tilt_tri_full::NMPCController::initialize(
...
bool nmpc_tilt_tri_full::NMPCController::update()
{
...
void nmpc_tilt_tri_full::NMPCController::reset()
{
  ControlBase::reset();
...
void nmpc_tilt_tri_full::NMPCController::controlCore()
{
...
void nmpc_tilt_tri_full::NMPCController::SendCmd()
{
...
nav_msgs::Odometry nmpc_tilt_tri_full::NMPCController::getOdom()
{
  tf::Vector3 pos = estimator_->getPos(Frame::COG, estimate_mode_);
  tf::Vector3 vel = estimator_->getVel(Frame::COG, estimate_mode_);
  tf::Vector3 rpy = estimator_->getEuler(Frame::COG, estimate_mode_);
 ...
 */
void nmpc_tilt_tri_full::NMPCController::callbackViz(const ros::TimerEvent& event)
{
...
void nmpc_tilt_tri_full::NMPCController::callbackJointStates(const sensor_msgs::JointStateConstPtr& msg)
{
...
void nmpc_tilt_tri_full::NMPCController::callbackSetRPY(const spinal::DesireCoordConstPtr& msg)
{
...
void nmpc_tilt_tri_full::NMPCController::callbackSetRefTraj(const aerial_robot_msgs::PredXUConstPtr& msg)
{
...
void nmpc_tilt_tri_full::NMPCController::initAllocMat()
{
...
void nmpc_tilt_tri_full::NMPCController::calXrUrRef(const tf::Vector3 target_pos, const tf::Vector3 target_vel,
...
void nmpc_tilt_tri_full::NMPCController::cfgNMPCCallback(NMPCConfig& config, uint32_t level)
{
...
PLUGINLIB_EXPORT_CLASS(aerial_robot_control::nmpc_tilt_tri_full::NMPCController, aerial_robot_control::ControlBase);
