...
void nmpc_tilt_tri_full::initPredXU(aerial_robot_msgs::PredXU& x_u)
{
...
void nmpc_tilt_tri_full::MPCSolver::setReference(const aerial_robot_msgs::PredXU& x_u_ref, const unsigned int x_stride,
...
double nmpc_tilt_tri_full::MPCSolver::solveOCPOnce()
{
...
void nmpc_tilt_tri_full::MPCSolver::getSolution(const unsigned int x_stride, const unsigned int u_stride)
{
  for (int i = 0; i < NN; i++)
  {
...
void nmpc_tilt_tri_full::MPCSolver::printSolution()
{
  std::stringstream ss;
...
void nmpc_tilt_tri_full::MPCSolver::printStatus(const double min_time)
{
  double kkt_norm_inf;
  int sqp_iter;
...
void nmpc_tilt_tri_full::MPCSolver::setCostWDiagElement(int index, double value, bool is_set_WN) const
{
  if (index < nx_ + nu_)
...
void nmpc_tilt_tri_full::MPCSolver::setCostWeight(bool is_update_W, bool is_update_WN)
{
  if (is_update_W)
  {
    for (int i = 0; i < NN; i++)
