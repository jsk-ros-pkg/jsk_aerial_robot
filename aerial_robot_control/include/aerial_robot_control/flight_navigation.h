...
namespace aerial_robot_navigation
{
  ...
  public:
    ...
    /* Battery information */
    static constexpr uint8_t LOW_BATTERY_STATE = 0x10;    // Abnormal state
    static constexpr uint8_t FORCE_LANDING_STATE = 0x11;  // Abnormal state
  ...
  protected:
    ...
    double nav_vel_limit_;      // Velocity limitation
    double vel_nav_threshold_;  // Range in which to switch between vel_nav and pos_nav
