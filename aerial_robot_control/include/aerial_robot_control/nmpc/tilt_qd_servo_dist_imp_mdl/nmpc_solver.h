...
#ifndef TILT_QD_SERVO_DIST_IMP_MDL_NMPC_SOLVER_H
#define TILT_QD_SERVO_DIST_IMP_MDL_NMPC_SOLVER_H

#include "aerial_robot_control/nmpc/base_mpc_solver.h"
#include "aerial_robot_control/nmpc/tilt_qd_servo_dist_imp_mdl/c_generated_code/acados_solver_tilt_qd_servo_dist_imp_mdl.h"
...
class TiltQdServoDistImpMdlMPCSolver : public BaseMPCSolver
{
public:
  TiltQdServoDistImpMdlMPCSolver()
  {
    // acados macro
    NN_ = TILT_QD_SERVO_DIST_IMP_MDL_N;
    NX_ = TILT_QD_SERVO_DIST_IMP_MDL_NX;
    NZ_ = TILT_QD_SERVO_DIST_IMP_MDL_NZ;
    NU_ = TILT_QD_SERVO_DIST_IMP_MDL_NU;
    NP_ = TILT_QD_SERVO_DIST_IMP_MDL_NP;
    NBX_ = TILT_QD_SERVO_DIST_IMP_MDL_NBX;
    NBX0_ = TILT_QD_SERVO_DIST_IMP_MDL_NBX0;
    NBU_ = TILT_QD_SERVO_DIST_IMP_MDL_NBU;
    NSBX_ = TILT_QD_SERVO_DIST_IMP_MDL_NSBX;
    NSBU_ = TILT_QD_SERVO_DIST_IMP_MDL_NSBU;
    NSH_ = TILT_QD_SERVO_DIST_IMP_MDL_NSH;
    NSH0_ = TILT_QD_SERVO_DIST_IMP_MDL_NSH0;
    NSG_ = TILT_QD_SERVO_DIST_IMP_MDL_NSG;
    NSPHI_ = TILT_QD_SERVO_DIST_IMP_MDL_NSPHI;
    NSHN_ = TILT_QD_SERVO_DIST_IMP_MDL_NSHN;
    NSGN_ = TILT_QD_SERVO_DIST_IMP_MDL_NSGN;
    NSPHIN_ = TILT_QD_SERVO_DIST_IMP_MDL_NSPHIN;
    NSPHI0_ = TILT_QD_SERVO_DIST_IMP_MDL_NSPHI0;
    NSBXN_ = TILT_QD_SERVO_DIST_IMP_MDL_NSBXN;
    NS_ = TILT_QD_SERVO_DIST_IMP_MDL_NS;
    NS0_ = TILT_QD_SERVO_DIST_IMP_MDL_NS0;
    NSN_ = TILT_QD_SERVO_DIST_IMP_MDL_NSN;
    NG_ = TILT_QD_SERVO_DIST_IMP_MDL_NG;
    NBXN_ = TILT_QD_SERVO_DIST_IMP_MDL_NBXN;
    NGN_ = TILT_QD_SERVO_DIST_IMP_MDL_NGN;
    NY0_ = TILT_QD_SERVO_DIST_IMP_MDL_NY0;
    NY_ = TILT_QD_SERVO_DIST_IMP_MDL_NY;
    NYN_ = TILT_QD_SERVO_DIST_IMP_MDL_NYN;
    NH_ = TILT_QD_SERVO_DIST_IMP_MDL_NH;
    NHN_ = TILT_QD_SERVO_DIST_IMP_MDL_NHN;
    NH0_ = TILT_QD_SERVO_DIST_IMP_MDL_NH0;
    NPHI0_ = TILT_QD_SERVO_DIST_IMP_MDL_NPHI0;
    NPHI_ = TILT_QD_SERVO_DIST_IMP_MDL_NPHI;
    NPHIN_ = TILT_QD_SERVO_DIST_IMP_MDL_NPHIN;
    NR_ = TILT_QD_SERVO_DIST_IMP_MDL_NR;

    // acados functions that only using once
    acados_ocp_capsule_ = tilt_qd_servo_dist_imp_mdl_acados_create_capsule();
    ...
    nlp_in_ = tilt_qd_servo_dist_imp_mdl_acados_get_nlp_in(acados_ocp_capsule_);
    nlp_out_ = tilt_qd_servo_dist_imp_mdl_acados_get_nlp_out(acados_ocp_capsule_);
    nlp_solver_ = tilt_qd_servo_dist_imp_mdl_acados_get_nlp_solver(acados_ocp_capsule_);
    nlp_opts_ = tilt_qd_servo_dist_imp_mdl_acados_get_nlp_opts(acados_ocp_capsule_);
  };

  ~TiltQdServoDistImpMdlMPCSolver() override
  {
    int status = tilt_qd_servo_dist_imp_mdl_acados_free(acados_ocp_capsule_);
    if (status)
      std::cout << "tilt_qd_servo_dist_imp_mdl_acados_free() returned status " << status << ". \n" << std::endl;
...
protected:
  ...
  void setCostWeightByImpMDK(bool is_set_WN = true)
  {
    ...
    W_mtx.block<3, 3>(20, 20) = o_weight_mtx.block<3, 3>(6, 6);
    // Q[7:13, 20:23] = o_weight_mtx[0:6, 6:9]
    W_mtx.block<6, 3>(7, 20) = o_weight_mtx.block<6, 3>(0, 6);
    // Q[20:23, 7:13] = o_weight_mtx[6:9, 0:6]
    W_mtx.block<3, 6>(20, 7) = o_weight_mtx.block<3, 6>(6, 0);
  ...
  {
    return tilt_qd_servo_dist_imp_mdl_acados_update_params(acados_ocp_capsule_, stage, value.data(), NP_);
  }
  ...
  {
    return tilt_qd_servo_dist_imp_mdl_acados_solve(acados_ocp_capsule_);
  }

  inline void acadosPrintStats() override
  {
    tilt_qd_servo_dist_imp_mdl_acados_print_stats(acados_ocp_capsule_);
  }
};
...
#endif  // TILT_QD_SERVO_DIST_IMP_MDL_NMPC_SOLVER_H
