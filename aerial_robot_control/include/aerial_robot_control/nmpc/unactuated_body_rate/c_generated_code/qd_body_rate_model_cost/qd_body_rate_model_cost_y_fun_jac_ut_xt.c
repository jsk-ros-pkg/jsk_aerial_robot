...
/* qd_body_rate_model_cost_y_fun_jac_ut_xt:(i0[10],i1[4],i2[],i3[],i4[5])->(o0[14],o1[14x14,22nz],o2[14x0]) */
...
CASADI_SYMBOL_EXPORT int qd_body_rate_model_cost_y_fun_jac_ut_xt(const casadi_real** arg, casadi_real** res,
...
CASADI_SYMBOL_EXPORT casadi_int qd_body_rate_model_cost_y_fun_jac_ut_xt_n_in(void)
{
  return 5;
}

CASADI_SYMBOL_EXPORT casadi_int qd_body_rate_model_cost_y_fun_jac_ut_xt_n_out(void)
{
  return 3;
}
...
CASADI_SYMBOL_EXPORT int qd_body_rate_model_cost_y_fun_jac_ut_xt_work(casadi_int* sz_arg, casadi_int* sz_res,
