...
#ifndef TILT_MT_NEURAL_SERVO_MINUS_NMPC_CONTROLLER_H
#define TILT_MT_NEURAL_SERVO_MINUS_NMPC_CONTROLLER_H
...
class TiltMtNeuralServoMinusNMPC : public BaseMPC
{
public:
  TiltMtNeuralServoMinusNMPC() = default;  // note that constructor should not have arguments as the rule of
                                           // rospluginlib
  ~TiltMtNeuralServoMinusNMPC() override = default;
...
#endif  // TILT_MT_NEURAL_SERVO_MINUS_NMPC_CONTROLLER_H
