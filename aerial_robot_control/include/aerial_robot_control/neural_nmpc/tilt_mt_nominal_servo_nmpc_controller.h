...
#ifndef TILT_MT_NOMINAL_SERVO_NMPC_CONTROLLER_H
#define TILT_MT_NOMINAL_SERVO_NMPC_CONTROLLER_H
...
class TiltMtNominalServoNMPC : public BaseMPC
{
public:
  TiltMtNominalServoNMPC() = default;  // note that constructor should not have arguments as the rule of rospluginlib
  ~TiltMtNominalServoNMPC() override = default;
...
#endif  // TILT_MT_NOMINAL_SERVO_NMPC_CONTROLLER_H
