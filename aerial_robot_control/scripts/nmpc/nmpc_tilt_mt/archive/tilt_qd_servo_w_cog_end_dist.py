...
from nmpc_tilt_mt.archive.phys_param_beetle_art import *
import nmpc_tilt_mt.archive.phys_param_beetle_art as phys


class NMPCTiltQdServoWCogEndDist(RecedingHorizonBase):
    """
    Controller Name: Tiltable Quadrotor NMPC including Servo Model as well Drag on each rotor as parameters and as CoG Disturbance.
    ...
    def create_acados_model(self) -> AcadosModel:
        ...
        control_y = ca.vertcat(ft, (ac - a))  # a_c_ref must be zero!
