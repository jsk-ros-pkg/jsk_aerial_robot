...
def main(file_path, type):
    ...
    # ======= Sensor-info =========
    data_imu_acc = data[["__time", "/beetle1/imu/acc_data[0]", "/beetle1/imu/acc_data[1]", "/beetle1/imu/acc_data[2]"]]
    data_imu_gyro = data[
    ...
    data_rpm_meas = data[
        [
            "__time",
            "/beetle1/esc_telem/esc_telemetry_1/rpm",
            "/beetle1/esc_telem/esc_telemetry_2/rpm",
            "/beetle1/esc_telem/esc_telemetry_3/rpm",
            "/beetle1/esc_telem/esc_telemetry_4/rpm",
        ]
    ]
