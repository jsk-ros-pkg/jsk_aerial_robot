...
Date: 2023/11/24 3:50 PM
Description: the output of the NMPC controller is the thrust for each rotor
"""
...
param_path = os.path.join(rospack.get_path("mini_quadrotor"), "config", "FlightControlNMPCFullModel.yaml")
