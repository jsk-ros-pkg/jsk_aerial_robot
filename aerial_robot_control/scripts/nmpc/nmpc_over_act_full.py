...
class NMPCOverActFull:
    ...
    def __init__(self):
        ...
        self._ocp_model = create_acados_model(self._set_name())
        self._ocp_solver = create_acados_ocp_solver(self._ocp_model)
        self._xr_ur_converter = XrUrConverter()
...
def create_acados_ocp_solver(opt_model: AcadosModel) -> AcadosOcpSolver:
...
def create_acados_model(model_name: str) -> AcadosModel:
    # model states
    p = ca.SX.sym("p", 3)
    v = ca.SX.sym("v", 3)
