...
from phys_param_trirotor import *

# read parameters from yaml
rospack = rospkg.RosPack()

param_path = os.path.join(rospack.get_path("gimbalrotor"), "config", "TiltTriRotorNMPC.yaml")
...
class NMPCTiltTriServoDist(NMPCBase):
    def __init__(self):
        super(NMPCTiltTriServoDist, self).__init__()
        self.t_servo = t_servo

    def _set_name(self) -> str:
        return "tilt_tri_servo_dist_mdl"
