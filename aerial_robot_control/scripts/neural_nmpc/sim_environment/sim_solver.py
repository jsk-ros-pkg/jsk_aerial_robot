...
def create_acados_sim_solver(mpc: NeuralNMPC, acados_model: AcadosModel, T_sim) -> AcadosSimSolver:
    ...
    mpc.sim_acados_parameters = np.zeros(n_param)
    mpc.sim_acados_parameters[0] = 1.0  # qw
    mpc.sim_acados_parameters[4 : 4 + len(mpc.phys.physical_param_list)] = np.array(mpc.phys.physical_param_list)
    acados_sim.parameter_values = mpc.sim_acados_parameters
    # =====================================================================
