...
def batched_jacobian(func: Callable, inputs: torch.Tensor, create_graph=False, return_func_output=False):
    ...
    jacobian = torch.autograd.functional.jacobian(
        func_sum_batch, inputs, vectorize=True, create_graph=create_graph
...
def batched_hessian(
    func: Callable, inputs: torch.Tensor, create_graph=False, return_jacobian=False, return_func_output=False
):
    r"""
