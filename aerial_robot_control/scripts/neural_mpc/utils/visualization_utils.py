...
def plot_dataset(
    ...
    plt.plot(t, state_in[:, 0], label="state_in")
    plt.plot(t, state_out[:, 0], label="state_out")
    plt.plot(t, state_prop[:, 0], label="state_prop")
    plt.legend()
    plt.ylabel("x [m]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ...
    plt.subplot(3, 1, 2)
    plt.plot(t, state_in[:, 1])
    plt.plot(t, state_out[:, 1])
    plt.plot(t, state_prop[:, 1])
    plt.ylabel("y [m]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ax = plt.gca()
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(3, 1, 3)
    plt.plot(t, state_in[:, 2])
    plt.plot(t, state_out[:, 2])
    plt.plot(t, state_prop[:, 2])
    plt.ylabel("z [m]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    plt.tight_layout()
    ...
    if use_moving_average_filter:
        ...
        plt.plot(t, state_in[:, 0], label="state_in")
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 0], label="state_in_filtered")
        plt.legend()
        plt.ylabel("x [m]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ...
        plt.plot(t, state_in[:, 1])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 1])
        plt.ylabel("y [m]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ax = plt.gca()
        ...
        plt.plot(t, state_in[:, 2])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 2])
        plt.ylabel("z [m]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        plt.tight_layout()
    ...
    plt.plot(t, state_in[:, 3], label="state_in")
    plt.plot(t, state_out[:, 3], label="state_out")
    plt.plot(t, state_prop[:, 3], label="state_prop")
    plt.legend()
    plt.ylabel("vx [m]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ...
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(3, 1, 2)
    plt.plot(t, state_in[:, 4])
    plt.plot(t, state_out[:, 4])
    plt.plot(t, state_prop[:, 4])
    plt.ylabel("vy [m]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ax = plt.gca()
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(3, 1, 3)
    plt.plot(t, state_in[:, 5])
    plt.plot(t, state_out[:, 5])
    plt.plot(t, state_prop[:, 5])
    plt.ylabel("vz [m]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    plt.tight_layout()
    ...
    if use_moving_average_filter:
        ...
        plt.plot(t, state_in[:, 3], label="state_in")
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 3], label="state_in_filtered")
        plt.legend()
        plt.ylabel("vx [m]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ...
        plt.plot(t, state_in[:, 4])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 4])
        plt.ylabel("vy [m]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ax = plt.gca()
        ...
        plt.plot(t, state_in[:, 5])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 5])
        plt.ylabel("vz [m]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        plt.tight_layout()
    ...
    plt.plot(t, state_in[:, 6], label="state_in")
    plt.plot(t, state_out[:, 6], label="state_out")
    plt.plot(t, state_prop[:, 6], label="state_prop")
    plt.legend()
    plt.ylabel("qw")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ...
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(4, 1, 2)
    plt.plot(t, state_in[:, 7])
    plt.plot(t, state_out[:, 7])
    plt.plot(t, state_prop[:, 7])
    plt.ylabel("qx")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ax = plt.gca()
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(4, 1, 3)
    plt.plot(t, state_in[:, 8])
    plt.plot(t, state_out[:, 8])
    plt.plot(t, state_prop[:, 8])
    plt.ylabel("qy")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ax = plt.gca()
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(4, 1, 4)
    plt.plot(t, state_in[:, 9])
    plt.plot(t, state_out[:, 9])
    plt.plot(t, state_prop[:, 9])
    plt.ylabel("qz")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    plt.tight_layout()
    ...
    plt.plot(t, state_in[:, 10], label="state_in")
    plt.plot(t, state_out[:, 10], label="state_out")
    plt.plot(t, state_prop[:, 10], label="state_prop")
    plt.legend()
    plt.ylabel("wx [rad/s]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ...
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(3, 1, 2)
    plt.plot(t, state_in[:, 11])
    plt.plot(t, state_out[:, 11])
    plt.plot(t, state_prop[:, 11])
    plt.ylabel("wy [rad/s]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    ax = plt.gca()
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(3, 1, 3)
    plt.plot(t, state_in[:, 12])
    plt.plot(t, state_out[:, 12])
    plt.plot(t, state_prop[:, 12])
    plt.ylabel("wz [rad/s]")
    plt.xlim(t[0], t[-1])
    plt.grid("on")
    plt.tight_layout()
    ...
    if use_moving_average_filter:
        ...
        plt.plot(t, state_in[:, 6], label="state_in")
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 6], label="state_in_filtered")
        plt.legend()
        plt.ylabel("qw")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ...
        plt.plot(t, state_in[:, 7])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 7])
        plt.ylabel("qx")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ax = plt.gca()
        ...
        plt.plot(t, state_in[:, 8])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 8])
        plt.ylabel("qy")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ax = plt.gca()
        ...
        plt.plot(t, state_in[:, 9])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 9])
        plt.ylabel("qz")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        plt.tight_layout()
    ...
    plt.plot(t, state_in[:, 13], label="state_in")
    plt.plot(t, state_out[:, 13], label="state_out")
    plt.plot(t, state_prop[:, 13], label="state_prop")
    plt.legend()
    ...
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(4, 1, 2)
    plt.plot(t, state_in[:, 14])
    plt.plot(t, state_out[:, 14])
    plt.plot(t, state_prop[:, 14])
    ...
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(4, 1, 3)
    plt.plot(t, state_in[:, 15])
    plt.plot(t, state_out[:, 15])
    plt.plot(t, state_prop[:, 15])
    ...
    ax.axes.xaxis.set_ticklabels([])
    plt.subplot(4, 1, 4)
    plt.plot(t, state_in[:, 16])
    plt.plot(t, state_out[:, 16])
    plt.plot(t, state_prop[:, 16])
    ...
    if use_moving_average_filter:
        ...
        plt.plot(t, state_in[:, 13], label="state_in")
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 13], label="state_in_filtered")
        plt.legend()
        plt.ylabel("alpha 1 [rad]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ...
        plt.plot(t, state_in[:, 14])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 14])
        plt.ylabel("alpha 2 [rad]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ax = plt.gca()
        ...
        plt.plot(t, state_in[:, 15])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 15])
        plt.ylabel("alpha 3 [rad]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        ax = plt.gca()
        ...
        plt.plot(t, state_in[:, 16])
        if use_moving_average_filter:
            plt.plot(t, state_in_filtered[:, 16])
        plt.ylabel("alpha 4 [rad]")
        plt.xlim(t[0], t[-1])
        plt.grid("on")
        plt.tight_layout()
    ...
    plt.plot(t, control[:, 0], label="thrust_cmd_1")
    plt.plot(t, control[:, 1], label="thrust_cmd_2")
    plt.plot(t, control[:, 2], label="thrust_cmd_3")
    plt.plot(t, control[:, 3], label="thrust_cmd_4")
    if use_moving_average_filter:
        plt.plot(t, control_in_filtered[:, 0], label="thrust_cmd_1_filtered", linestyle="--")
        plt.plot(t, control_in_filtered[:, 1], label="thrust_cmd_2_filtered", linestyle="--")
        plt.plot(t, control_in_filtered[:, 2], label="thrust_cmd_3_filtered", linestyle="--")
        plt.plot(t, control_in_filtered[:, 3], label="thrust_cmd_4_filtered", linestyle="--")
    ...
    # --- Servo Angle Command
    plt.subplot(2, 1, 2)
    plt.plot(t, control[:, 4], label="servo_cmd_1")
    plt.plot(t, control[:, 5], label="servo_cmd_2")
    plt.plot(t, control[:, 6], label="servo_cmd_3")
    plt.plot(t, control[:, 7], label="servo_cmd_4")
    if use_moving_average_filter:
        plt.plot(t, control_in_filtered[:, 4], label="servo_cmd_1_filtered", linestyle="--")
        plt.plot(t, control_in_filtered[:, 5], label="servo_cmd_2_filtered", linestyle="--")
        plt.plot(t, control_in_filtered[:, 6], label="servo_cmd_3_filtered", linestyle="--")
        plt.plot(t, control_in_filtered[:, 7], label="servo_cmd_4_filtered", linestyle="--")
    ...
    for dim in range(y.shape[1]):
        ...
        if use_moving_average_filter:
            plt.plot(t, y_raw[:, dim], color="tab:red")
            plt.plot(t, y_filtered[:, dim], label="filtered", color="tab:blue")
        else:
            plt.plot(t, y[:, dim], color="tab:red")
        if dim == 0:
    ...
    for dim in range(state_in.shape[1]):
        ...
        plt.plot(t, y_all[:, dim], color="green")
        if dim == 0:
