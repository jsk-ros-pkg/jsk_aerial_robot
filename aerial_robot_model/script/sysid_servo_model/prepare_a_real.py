...
for topic, msg, timestamp in bag.read_messages(topics=[joint_states_topic_name]):
    if topic == joint_states_topic_name:
        ...
        print(
            f"joint_states: {timestamp.to_sec()}, {msg.position[0]}, {msg.position[1]}, {msg.position[2]}, {msg.position[3]}"
        )
