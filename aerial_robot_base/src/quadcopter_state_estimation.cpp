...
Estimator1::Estimator1(ros::NodeHandle nh,
...
float Estimator1::getStatePosXc()
{
  if(useOuterPoseEstimate & X_AXIS)
    {
      float state_pos_xc
...
float Estimator1::getStateVelXc()
{
  if(useOuterVelEstimate & X_AXIS)
    {
      float state_vel_xc
...
float Estimator1::getStateAccXb()
{
  return imuData_->getAccXbValue();
}

float Estimator1::getStatePosY()
{
...
float Estimator1::getStatePosYc()
{
 if(useOuterPoseEstimate & Y_AXIS)
   {
      float state_pos_yc
...
float Estimator1::getStateVelYc()
{
 if(useOuterVelEstimate & Y_AXIS)
   {
      float state_vel_yc
...
float Estimator1::getStateAccYb()
{
  return imuData_->getAccYbValue();
}

float Estimator1::getStatePosZ()
{
...
float Estimator1::getStateAccZb()
{
  return imuData_->getAccZbValue();
}

float Estimator1::getStateTheta()
{
...
float Estimator1::getStatePsiCog()
{
...
float Estimator1::getStateVelPsiCog()
{
...
float Estimator1::getStatePsiBody()
{
  if(useOuterPoseEstimate & YAW_AXIS)
    {      
...
float Estimator1::getStateVelPsiBody()
{
  if(useOuterVelEstimate & YAW_AXIS)
    {      
...
float Estimator1::getStateVelXOpt()
{
  return opticalFlowData_->getRawVelX();
}
float Estimator1::getStateVelYOpt()
{
  return opticalFlowData_->getRawVelY();
}


bool Estimator1::getRocketStartFlag()
{
...
void Estimator1::setRocketStartFlag()
{
  if(altitudeControlMode_ == SONAR)
    opticalFlowData_->setRocketStartFlag();
}

void Estimator1::tfPublish()
{
...
float Estimator1::getLaserToImuDistance()
{
  return laserToBaselinkDistance_;
}

void Estimator1::setKalmanFilterBoardToAsctec()
{
  imuData_->setKalmanFilterBoardToAsctec();
}

void Estimator1::rosParamInit()
{
